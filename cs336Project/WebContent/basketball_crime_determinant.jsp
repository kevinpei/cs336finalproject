...
<div class="navigation" id="navigationbar">
  ...
  <a href="basketball_administrator_index.jsp">Basketball for Administrators</a>
	...
	try {
			...
			str = "SELECT f.SCHOOL, AVG(f.CRIMES), s.ENDOWMENT, s.SPORTSEXPENSES, t.BCOACHPAY FROM cs336project.PlayerData f, cs336project.SchoolData s, cs336project.BasketballTeamData t WHERE f.SCHOOL = s.SCHOOL and f.SCHOOl = t.SCHOOL GROUP BY f.SCHOOL ORDER BY AVG(f.CRIMES) desc";
			...
			out.print("<th>Basketball Coach Pay</th>");
			out.print("</tr>");
			...
			while (result.next()) {
				...
				out.print("<td>" + result.getString("t.BCOACHPAY") + "</td>");
				out.print("</tr>");
			} //end while loop
			out.print("</table>");
			//close the connection.
			out.print("<img src=\"basketball_crime.png\" />");
			con.close();
